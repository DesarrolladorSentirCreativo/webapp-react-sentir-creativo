...
const CreateFormEstadoServicio: FC = () => {
  ...
  const formik = useFormik<ICreateEstadoServicio>({
    initialValues: {
      nombre: '',
      color: '',
      descripcion: ''
    ...
    onSubmit: async (values) => {
      setIsLoading(true)
      try {
        await estadoServicioService.create(values, userId)
        getSuccess('El Estado de Servicio fue creado correctamente')
        navigate('/estados-servicios')
      } catch (e) {
        console.log(e)
        getError('El Estado de Servicio no pudo ser creado')
        setIsLoading(false)
      }
    }
  })
      ...
      <Card title="Formulario">
        <Box component="form" onSubmit={formik.handleSubmit}>
          <Typography variant="h5" sx={{ textAlign: 'center' }}>
            Formulario para Creación de Estado de Servicio
          </Typography>
...
export default CreateFormEstadoServicio
