...
const CreateFormOCacion: FC = () => {
  ...
  const formik = useFormik<ICreateOcacion>({
    initialValues: {
      nombre: ''
    },
...
export default CreateFormOCacion
