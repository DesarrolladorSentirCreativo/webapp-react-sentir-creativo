...
const CreateFormTecnicaArtistica: FC = () => {
  ...
  const formik = useFormik<ICreateTecnicaArtistica>({
    initialValues: {
      nombre: ''
    },
    ...
    onSubmit: async (values) => {
      setIsLoading(true)
      try {
        await tecnicaArtisticaService.create(values, userId)
        getSuccess('La tecnica artistica fue creada correctamente')
        navigate('/tecnicas-artisticas')
      } catch (e) {
        console.log(e)
        getError('La tecnica artistica no pudo ser creada')
        setIsLoading(false)
      }
    }
  })
...
export default CreateFormTecnicaArtistica
