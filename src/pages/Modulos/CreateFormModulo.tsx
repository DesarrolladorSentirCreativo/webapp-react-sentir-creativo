...
const CreateFormModulo: FC = () => {
  ...
  const formik = useFormik<ICreateModulo>({
    ...
    onSubmit: async (values) => {
      setIsLoading(true)
      try {
        await moduloService.create(values, userId)
        getSuccess('El modulo fue creado correctamente')
        navigate('/modulos')
      } catch (e) {
        console.log(e)
        getError('El modulo no pudo ser creado')
        setIsLoading(false)
      }
    }
  })
      ...
      <Card title="Formulario">
        <Box component="form" onSubmit={formik.handleSubmit}>
          <Typography variant="h5" sx={{ textAlign: 'center' }}>
            Formulario para Creación de Modulo
          </Typography>
...
export default CreateFormModulo
